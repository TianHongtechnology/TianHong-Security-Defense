...
void ElaCentralStackedWidget::doWindowStackSwitch(ElaWindowType::StackSwitchMode stackSwitchMode, int nodeIndex, bool isRouteBack)
{
    ...
    case ElaWindowType::Scroll:
    {
        ...
        targetWidget->setVisible(false);
        _pScrollAnimationOffset = 0;
        QPropertyAnimation* scrollAnimation = new QPropertyAnimation(this, "pScrollAnimationOffset");
        connect(scrollAnimation, &QPropertyAnimation::valueChanged, this, [=]() {
            update();
        });
        ...
        scrollAnimation->setDuration(350);
        scrollAnimation->setStartValue(0);
        scrollAnimation->setEndValue(height());
